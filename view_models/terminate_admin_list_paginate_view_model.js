...
module.exports = function (entity, pageName, success, error, baseUrl) {
  ...
  this._list = [];
  this._column = ["Id", "Message", "Counter"];
  this._readable_column = ["Id", "Message", "Counter"];
  this._entity = entity;
  this._heading = "Terminate";
  ...
  this._page;
  this._num_links = 5;
  this._field_column = ["id", "message", "counter"];
  this._readable_field_column = ["id", "message", "counter"];
  this._links = "";
  this._sort_base_url = "";
  this._order_by = "";
  this._sort = "";
